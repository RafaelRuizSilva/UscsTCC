...
from app.core.models.relatorio_mensal import (
    ConfirmarRelatorioMensalDTO,
    RelatorioMensalOut,
    PendenciaOut,
    RelatorioMensalSecretariaOut,
...
def listar_pendentes_do_mes(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao listar pendências: {e}")
...
def listar_meus_relatorios_do_mes(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao listar relatórios: {e}")
...
def confirmar_relatorio_mensal(
    ...
    try:
            ...
            publisher.publish(
                {
                    ...
                    "mensagem": (
                        ...
                        f"'{titulo_projeto}' (mês {mes_ref.strftime('%Y-%m')})."
                    ),
        ...
        return {"id_relatorio": id_relatorio}
        ...
        raise HTTPException(status_code=500, detail="Erro inesperado ao confirmar relatório")
...
def listar_relatorios_secretaria(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao listar relatórios da secretaria: {e}")
...
def listar_pendentes_secretaria(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao listar pendências da secretaria: {e}")
